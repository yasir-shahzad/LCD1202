...
static const char mass10x10[1][24] PROGMEM ={
   {0x04, 0x06, 0xFF, 0xFF, 0x06, 0x84, 0x80, 0xFE, 0xFE, 0x80,0x80, 0x00,
    0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x03, 0x03, 0x01,0x00, 0x00,}
   };
